...
import { SignupInput } from "@ashitosh007/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Ashitosh Madhukar Sable" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="ashitosh@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
